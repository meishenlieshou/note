...
<span class="line"><span>        ├── package.json</span></span>
<span class="line"><span>        └── node_modules/ &#x3C;-- 链接到根目录</span></span></code></pre>

<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="它的优点和缺点是什么" tabindex="-1"><a class="header-anchor" href="#它的优点和缺点是什么"><span>它的优点和缺点是什么？</span></a></h2>
<ul>
...
<ul>
<li>Lerna 提供工具**<code v-pre>管理版本</code>**、 <strong><code v-pre>发布</code></strong> 和 <strong><code v-pre>增量构建</code></strong></li>
