import { ExactLocaleConfig, DefaultLocaleInfo } from '@vuepress/helper';
...
export { type PhotoSwipePluginLocaleConfig, type PhotoSwipePluginLocaleData, type PhotoSwipePluginOptions, photoSwipeLocaleInfo, photoSwipePlugin };
